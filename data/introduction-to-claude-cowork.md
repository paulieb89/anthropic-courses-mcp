...
- [What is Cowork?](#what-is-cowork)
- [Getting set up](#getting-set-up)
- [The task loop](#the-task-loop)
- [Giving Cowork context](#giving-cowork-context)
- [Plugins: Cowork as a specialist](#plugins-cowork-as-a-specialist)
- [Scheduled tasks](#scheduled-tasks)
- [File & document tasks](#file-document-tasks)
- [Research & analysis at scale](#research-analysis-at-scale)
- [Permissions, usage, & choosing your model](#permissions-usage-choosing-your-model)
- [Troubleshooting & next steps](#troubleshooting-next-steps)
- [Quiz on Claude Cowork](#quiz-on-claude-cowork)

## What is Cowork?

Source: https://anthropic.skilljar.com/introduction-to-claude-cowork/444164
...
- **Connect.** Cowork can reach the systems where your work lives: your email, shared drives, the tools you're already signed into. Context flows to Claude without manual copy-paste.
 ...
 Overview You'll go deeper on each in later lessons. For now, the map:
...
- **Local computation** — Run code on files in place and write results back. No upload and re-download cycle.
 ...
 For more on deciding what to delegate to Claude and how, see the [AI Fluency course](https://www.anthropic.com/ai-fluency).
 ...
 For more on Cowork's design and purpose, see [Claude Cowork: a research preview](https://claude.com/resources/tutorials/claude-cowork-a-research-preview).
...
- Understand what you need to have in place
 ...
 Overview Cowork runs in the [Claude Desktop app](https://claude.com/download). It's available on paid Claude plans—[check your plan details](https://claude.com/pricing) for current availability.

 ### Opening Cowork

 Overview Open Claude Desktop. At the top of the app, you'll find a mode selector that lets you move between Chat, Cowork, and Code. Click **Cowork**.
...
- Approach finished outputs with the right reviewing mindset
 ...
 Overview Claude proposes a plan and waits for your approval before taking action. You adjust if needed, approve, and Claude executes. This is the pattern for every Cowork task.
 ...
 Overview Overview You don't need to know how Cowork works under the hood to use it. But a rough picture helps you write better prompts and recognize when a task is a good fit.
...
- **Deletion is gated** — Cowork asks before permanently deleting files. You approve or decline.
 ...
 "Review everything in this folder and create a leadership presentation for the tooling review. Include the vendor evaluation results, timeline, business case, and open risks. Output a PowerPoint file." #### Review the plan
 ...
 For more on these habits, see the [AI Fluency course](https://www.anthropic.com/ai-fluency).
...
- Set global instructions for preferences that apply everywhere
 ...
 Overview Each Cowork task starts fresh—Claude doesn't carry conversation memory from one task to the next. The way context carries over is a **project**: a named workspace backed by a real folder on your machine, with instructions and memory that persist into every task you start inside it.
...
- Understand skills as the building blocks plugins are made of
 ...
 Overview Plugins give Cowork domain expertise. Each one comes with built-in knowledge and workflows for a specific function, so Claude approaches your task the way a specialist would.
...
- **Subagents** — Parallelize specialized work. *Example: one agent per account in a book-wide review.*
 ...
 Overview 1. **Browse.** Plugins live in Cowork's **Customize** area. Find one that matches what you do.
...
- Understand how scheduled tasks behave when the app is closed or the machine is asleep
 ...
 Overview Scheduled tasks run any Cowork task automatically on a cadence you set—hourly, daily, weekly, or custom. The task can be anything: a prompt you've written, a plugin skill, or a workflow you've refined. Once you have something that works well, you can stop prompting for it each time.

 "Every Monday at 9am, pull my calendar and draft a weekly priorities email." ### Setting one up
...
Source: https://anthropic.skilljar.com/introduction-to-claude-cowork/444170
...
- **Templates and brand rules compound.** Once you've made a brand-guidelines skill (Lesson 6), every file Cowork produces can reference it.
 ...
 Overview These prompts are good starting points. Notice the shape: each one names the input, the transformation, and the output.

 #### Organize what you have

 "Sort my Downloads folder by file type into dated subfolders." "Rename all files in this folder using a consistent date-first format." "Create a formatted expense report from the receipts in this folder." #### Create what you need

 "Build a project tracking spreadsheet from these notes, with status columns and a summary view." "Turn these meeting notes into a slide deck. Use the brand-guidelines skill." "Combine the transcripts and notes in this folder into a formatted report." ### The prompt pattern
...
- Frame tasks to find the signal, not just produce a summary
 ...
 Overview Both chat and Cowork can help with research and analysis. The difference is in the shape of the work that fits each.
...
- **In-place computation.** Cowork can run code on files where they live and write results back to disk. No upload and re-download cycle. The output is already where you need it.
 ...
 "Read everything in the research folder and write a synthesis report. Where do the sources agree? Where do they contradict each other? Flag any claim that only one source makes." #### Transcript analysis
 ...
 "Read all transcripts in this folder. What did most people agree on? Who disagreed, and what do those people have in common?" You might learn that the outliers share a trait. That's the insight buried at scale.
 ...
 "For each customer in this file, calculate month-over-month usage change. Flag accounts with three consecutive months of decline and write a summary to the same folder." #### Knowledge synthesis

 Point Cowork at your own accumulated notes, journals, or project files and ask what patterns it finds.

 "Read all my project notes from the last six months. What questions keep coming up? What did I decide in one project that contradicts what I decided in another?" ### The framing: ask for the signal
...
Source: https://anthropic.skilljar.com/introduction-to-claude-cowork/444173
...
- Build the habit of reviewing outputs before acting on them
 ...
 Overview Cowork can read and write real files and connect to real systems. Here are the boundaries that shape how that works.
...
- **Deletion is gated** — Permanent deletion requires your explicit approval. You'll always see a prompt first.
 ...
 For more on this habit and the other competencies that make working with AI effective, see the [AI Fluency course](https://www.anthropic.com/ai-fluency).

 ### Managing usage

 Overview Cowork uses more of your allocation than chat does—multi-step, long-running work is more compute-intensive than a single turn. A few habits help you spend it well:
...
Source: https://anthropic.skilljar.com/introduction-to-claude-cowork/444174
...
- Know where to go for help beyond this course
 ...
 Overview #### Cowork is preparing your workspace
 ...
 Overview The goal: have a skill you trust running on a schedule. The steps to get there:
...
Source: https://anthropic.skilljar.com/introduction-to-claude-cowork/452288
